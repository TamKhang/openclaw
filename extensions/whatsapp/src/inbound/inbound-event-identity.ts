// Whatsapp plugin module formalizes the canonical inbound event identity.
// Observation and reply evaluation must both derive their durable identity from
// these fields so the same WhatsApp message cannot be independently reinterpreted.
