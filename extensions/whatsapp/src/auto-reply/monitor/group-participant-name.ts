// Whatsapp plugin module resolves the authoritative group participant name for
// an owner-delegated reply. The recent-sender roster is intentionally not the
// source of truth: Baileys group metadata participants carry the human names.
